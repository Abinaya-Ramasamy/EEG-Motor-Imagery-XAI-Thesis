...
MODEL_PATH = "../result/EEGNet_ICA_FIXED_FOR_XAI/model.pth"
TEST_DATA_PATH = "../result/EEGNet_ICA_FIXED_FOR_XAI/xai_fixed_test_data.npz"
PRED_PATH = "../result/EEGNet_ICA_FIXED_FOR_XAI/xai_fixed_predictions.npz"

RESULT_DIR = "../result/XAI_EEGNet_ICA_LEFT_RIGHT_FIXED_correct_only"
...
# SAVE EXCEL
# -----------------------------
excel_path = os.path.join(RESULT_DIR, "xai_left_right_fixed_ica_correct_only.xlsx")
