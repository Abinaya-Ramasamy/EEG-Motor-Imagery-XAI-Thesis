...
path.append('/projects/sciences/computing/ramab620/eegxai-sp-rnn/utils')
...
data_link = f'/projects/sciences/computing/ramab620/eegxai-sp-rnn/dataset/{snr}_{domain}'
model_link = f'/projects/sciences/computing/ramab620/eegxai-sp-rnn/dataset/{model_name}/'
result_link = f'/projects/sciences/computing/ramab620/eegxai-sp-rnn/result/{model_name}/'
